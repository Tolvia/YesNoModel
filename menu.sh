...
function train_model {
  ...
  sudo docker run --rm -v "$(pwd)/train_model:/app/Monosyllables" monosillabic-model bash -c "cd /app/Monosyllables && python train.py && cp monosyllables_model_v3.keras ../monosyllables_model_v3.keras"
